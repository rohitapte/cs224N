...
class SequencePredictor(Model):
    ...
    def add_training_op(self, loss):
        ...
        gradients=[value[0] for value in gradients_and_variables]
        variables=[value[1] for value in gradients_and_variables]
        ...
        gradients_and_variables=[(gradients[i],variables[i]) for i in range(len(gradients))]
