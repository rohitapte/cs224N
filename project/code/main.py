...
tf.app.flags.DEFINE_integer("context_word_len", 37, "The maximum length of context words of your model")
tf.app.flags.DEFINE_integer("question_word_len", 30, "The maximum length of question words of your model")
tf.app.flags.DEFINE_integer("character_embedding_size", 50, "Size of the pretrained character vectors. This needs to be 50")
