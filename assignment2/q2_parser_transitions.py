...
def minibatch_parse(sentences, model, batch_size):
    ...
    while len(unfinished_parses)>0:
        ...
        next_transitions=model.predict(minibatch_parses)
        #print(len(minibatch_parses))
        #print(len(next_transitions))
        for index,parse in enumerate(minibatch_parses):
            parse.parse_step(next_transitions[index])
